...
class ObjectNavPolicyRNNNet(Net):
...
class ObjectNavQRNNNet(ObjectNavPolicyRNNNet):
    def __init__(
            self,
            observation_space: Space,
            policy_config: Config,
...
class ObjectNavIQLRNNPolicy(IQLRNNPolicy):
    def __init__(
            self,
            observation_space: Space,
            action_space: Space,
