...
_TASK_CONFIG.TASK.REWARD_MEASURE = "distance_to_goal"

_TASK_CONFIG.TASK.SUCCESS_MEASURE = "spl"
...
_CONFIG.IL.BehaviorCloning.num_steps = 512
...
_CONFIG.OFF.BehaviorCloning.num_steps = 512
...
_CONFIG.POLICY.RGB_ENCODER.backbone = "resnet18"
