...
class MetaVectorEnv:
    ...
    def _worker_env(
        ...
        try:
            ...
            while command != CLOSE_COMMAND:
                ...
                elif command == TASK_COMMAND:
                    connection_write_fn(env.task_id)
    ...
    def set_task_at(self, index_env: int, task: Tuple[str, str]):
...
class MetaThreadedVectorEnv(MetaVectorEnv):
