...
from offnav.algos.ppo import DDPPO, PPO
from offnav.utils.lr_scheduler import PIRLNavLRScheduler


@baseline_registry.register_trainer(name="offnav-ddppo")
@baseline_registry.register_trainer(name="offnav-ppo")
